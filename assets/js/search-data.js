...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "CV",
          description: "M.Sc. student in Electrical Engineering at EPFL. Download the AI / vision CV or the AI hardware CV.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "FPGA, CUDA, and digital systems projects spanning CORDIC, FFT, MIPS, and GPU memory.",
          section: "Projects",handler: () => {
